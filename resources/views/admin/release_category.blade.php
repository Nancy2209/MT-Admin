            ...
            <div class="position-relative container-fluid px-0">
                <div class="row align-items-center position-relative">
                    <div class="col-md-8 mb-4 mb-md-0">
                        <h3 class="mb-2">Release Category</h3>
                    </div>
                    {{-- <div class="card-tools">
                        <button class="btn btn-primary" data-bs-toggle="modal" href="#exampleModalToggle"
                            style="float: right">Add Release Category</button>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> <a class="js-edit-logo" data-bs-toggle="modal"
                                                            ...
                                                            {{-- <a class="delete-material"
                                                                href="{{ route('delete.release.category', @$category->id) }}"
                                                                title="delete logo"
            ...
            <div class="modal fade" id="exampleModalToggle" aria-hidden="true" aria-labelledby="exampleModalToggleLabel"
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('admin.add.release.category') }}" method="post"
            ...
            <div class="modal fade" id="editModal" aria-hidden="true" aria-labelledby="exampleModalToggleLabel"
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('admin.edit.release.category') }}" method="post"
                            enctype="multipart/form-data" class="ajaxForm">
