                                            ...
                                            <tbody>
                                                @foreach ($metaTags as $tag)
                                                    <tr>
                                                        ...
                                                        <td>{{ $tag->mata_keyboard }}
                                                        </td>

                                                        <td>{{ substr($tag->mata_description, 0, 100) }}
                                                        </td>
                                                        <td>{{ substr($tag->canonical_tag, 0, 100) }}
                                                        </td>
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalToggleLabel">Add Meta Tag
                            </h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <form action="{{ route('admin.add.meta.tag') }}" id="addMedia" method="post"
                            ...
                            <div class="modal-body">
                                ...
                                <select class="form-control mb-2" name="page_name" required>
                                ...
                                <input class="form-control mb-2" type="text" placeholder="meta-Keywords"
                                    name="mata_keyboard" required>



                                <label for="maskPhone" class="form-label">Meta Description</label>
                                <textarea class="form-control mb-2" placeholder="meta description" name="mata_description" required></textarea>

                                <label for="maskPhone" class="form-label">Canonical Tag</label>
                                <textarea class="form-control mb-2" placeholder="Canonical Tag" name="canonical_tag" required></textarea>
                            </div>
            ...
            <div class="modal fade" id="editModal" aria-hidden="true" aria-labelledby="exampleModalToggleLabel"
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('admin.update.meta.tag') }}" id="updateMedia" method="post"
                            enctype="multipart/form-data" class="ajaxForm">
                            ...
                            <div class="modal-body">
                                ...
                                <input class="form-control mb-2" type="text" placeholder="meta-title"
                                    name="mata_title" id="mata_title" required>
