            ...
            <div class="position-relative container-fluid px-0">
                <div class="row align-items-center position-relative">
                    <div class="col-md-8 mb-4 mb-md-0">
                        <h3 class="mb-2">Student Hears</h3>


                    </div>
                    <div class="card-tools">
                        <button class="btn btn-primary" data-bs-toggle="modal" href="#exampleModalToggle"
                            style="float: right">Add Student Hear</button>
                                            ...
                                            <tbody>
                                                @foreach ($hears as $hear)
                                                    <tr>
                                                        ...
                                                        <td>{{ $hear->name }}</td>
                                                        <td>{{ $hear->designation }}</td>
                                                        <td>{{ substr($hear->description, 0, 100) }}...</td>
                                                        <td><img src="{{ asset('storage/' . $hear->image) }}"
                                                                width="25%"> </td>
                                                        <td> <a class="js-edit-logo" data-bs-toggle="modal"
                                                                href="#editModal" style="cursor:pointer" title="edit state"
                                                                data-id="{{ $hear->id }}"
                                                                data-name="{{ $hear->name }}"
                                                                data-designation="{{ $hear->designation }}"
                                                                data-description="{{ $hear->description }}"
                                                                data-image="{{ asset('storage/' . $hear->image) }}"><i
                                                                    class="fa fa-edit"></i></a>
                                                            <a class="delete-material"
                                                                href="{{ route('delete.student.hear', @$hear->id) }}"
                                                                title="delete logo"
            ...
            <div class="modal fade" id="exampleModalToggle" aria-hidden="true" aria-labelledby="exampleModalToggleLabel"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('admin.add.student.hear') }}" id="addTopper" method="post"
                            ...
                            <div class="modal-body">
                                <div class="card-body">
                                    ...
                                    <div class="form-group mb-1">
                                        <label for="email-1">Designation</label>
            ...
            <div class="modal fade" id="editModal" aria-hidden="true" aria-labelledby="exampleModalToggleLabel"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('admin.update.student.hear') }}" method="post" id="updateTopper"
